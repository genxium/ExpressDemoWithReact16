...
class List extends Component {
  ...
  componentDidMount() {
    const sceneRef = this;
    changeSceneTitle(sceneRef, LocaleManager.instance.effectivePack().WRITER_LIST);
  ...
  render() {
    ...
    if (null !== sceneRef.state.rootElementSize) {
      ...
      const listViewProps = Object.assign({
        ...
        dataUrl: namedGatewayInfo.protocol + "://" + namedGatewayInfo.apiGateway + basename + constants.ROUTE_PATHS.API_V1 + constants.ROUTE_PATHS.WRITER + constants.ROUTE_PATHS.PAGINATION + constants.ROUTE_PATHS.LIST,
